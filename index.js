...
app.get("/sub_categoly/:name/:id", function(req, reser, next) {
  var page = 1;
  if (req.query.page) {
    page = req.query.page;
  }
  ...
  request(
    "https://wall.alphacoders.com/by_sub_category.php?id=" +
      req.params.id +
      "&page=" +
      page,
    function(erro, res, html) {
...
app.get('all_categoly',function(req,reser){
    reser.send("all_categoly");
});
